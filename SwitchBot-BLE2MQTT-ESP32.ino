...
static const char* ssid = "DaVoKr";                                   //  WIFI SSID
static const char* password = "Bunker55aliveinside#AsLongAs142";                           //  WIFI Password

/* MQTT Settings */
/* MQTT Client name is set to WIFI host from Wifi Settings*/
static const char* mqtt_host = "192.168.1.40";                       //  MQTT Broker server ip
static const char* mqtt_user = "switchbot";                         //  MQTT Broker username. If empty or NULL, no authentication will be used
static const char* mqtt_pass = "AsLongAs142#";                         //  MQTT Broker password
